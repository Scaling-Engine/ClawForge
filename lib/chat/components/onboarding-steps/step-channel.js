...
function StepChannel({ onStepComplete }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-zinc-900 dark:text-zinc-100 mb-2", children: "Slack Channel" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-600 dark:text-zinc-400", children: "Connect a Slack channel to receive job notifications. ClawForge will post updates when jobs complete, fail, or need your attention. This step is optional \u2014 you can skip it and set it up later in Settings." })
    ] }),
    status === "success" && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 px-4 py-3", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-sm text-green-700 dark:text-green-300", children: "Slack webhook verified \u2014 test message sent successfully!" })
    ] }),
    status !== "success" && /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxs("label", { className: "block", children: [
        /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5 block", children: "Slack Incoming Webhook URL" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "url",
      ...
      status === "error" && errorMsg && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2 text-sm text-red-600 dark:text-red-400", children: [
        /* @__PURE__ */ jsx("svg", { className: "h-4 w-4 shrink-0 mt-0.5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" }) }),
        errorMsg
      ] })
    ] }),
