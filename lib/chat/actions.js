...
const SUPPORT_GUIDES = [
  { slug: 'operator-guide', title: 'Operator Guide', filename: 'OPERATOR_GUIDE.md' },
  { slug: 'configuration', title: 'Configuration', filename: 'CONFIGURATION.md' },
  { slug: 'deployment', title: 'Deployment', filename: 'DEPLOYMENT.md' },
  { slug: 'architecture', title: 'Architecture', filename: 'ARCHITECTURE.md' },
  { slug: 'security', title: 'Security', filename: 'SECURITY.md' },
  { slug: 'chat-integrations', title: 'Chat Integrations', filename: 'CHAT_INTEGRATIONS.md' },
  { slug: 'voice', title: 'Voice Input', filename: 'VOICE.md' },
  { slug: 'code-workspaces', title: 'Code Workspaces', filename: 'CODE_WORKSPACES_V2.md' },
  { slug: 'admin-panel', title: 'Admin Panel', filename: 'ADMIN_PANEL.md' },
  { slug: 'auto-merge', title: 'Auto-Merge Rules', filename: 'AUTO_MERGE.md' },
  { slug: 'customization', title: 'Customization', filename: 'CUSTOMIZATION.md' },
];
