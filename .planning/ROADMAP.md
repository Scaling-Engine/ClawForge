...
- v1.3 Instance Generator — Phases 13-17 + 16.1, 17.1, 17.2 (in progress)
...
- [x] **Phase 16.1: Entrypoint Sync** — Propagate --body-file from templates/entrypoint.sh to docker/job/entrypoint.sh (completed 2026-03-05)
...
- [x] **Phase 17: End-to-End Validation** — Real multi-turn conversation through PR creation (completed 2026-03-06)
  **Requirements:** [DELIV-03]
  **Plans:** 1 plan
  Plans:
  - [ ] 17-01-PLAN.md — Pre-validation checks, verification script, and live E2E pipeline test
- [x] **Phase 17.1: Context Hydration for Layer 1** — Add get_project_state tool so conversational agent can read .planning/STATE.md + ROADMAP.md from target repos via GitHub API before writing job.md. (completed 2026-03-06)
  **Plans:** 1 plan
  Plans:
  - [ ] 17.1-01-PLAN.md — Add fetchRepoFile helper, getProjectStateTool, and EVENT_HANDLER.md instructions
...
| 17.1. Context Hydration (Layer 1) | 1/1 | Complete   | 2026-03-06 | - |
...
---
*Last updated: 2026-03-05 — Phase 17.2 added (Layer 2 context hydration), docs/CONTEXT_ENGINEERING.md created*
